...
{
    public class UpdateOrderCommandValidator : AbstractValidator<UpdateOrderCommandRequestModel>
    {
        #region Fields
        ...
        #region Constructor
        public UpdateOrderCommandValidator(IStringLocalizer<AppLocalization> stringLocalizer, IOrderService orderService)
        {
