...
{
    public class DeleteOrderCommandValidator : AbstractValidator<DeleteOrderCommandRequestModel>
    {
        #region Fields
        ...
        #region Constructor
        public DeleteOrderCommandValidator(IStringLocalizer<AppLocalization> stringLocalizer, IOrderService orderService)
        {
